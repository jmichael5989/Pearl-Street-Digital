        ...
        <section className="bg-white py-16 lg:py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="space-y-8 text-gray leading-relaxed text-sm">
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Payment Terms</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Client Responsibilities</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Cancellation and Refunds</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Website Use</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Governing Law</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Changes to Terms</h2>
