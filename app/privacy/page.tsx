        ...
        <section className="bg-white py-16 lg:py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-gray">
            ...
            <div className="space-y-8 text-gray leading-relaxed text-sm">
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Information We Collect</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">How We Use Your Information</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Cookies and Analytics</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Data Security</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Third-Party Services</h2>
              ...
              <div>
                <h2 className="font-heading text-xl font-bold text-dark mb-3">Changes to This Policy</h2>
