...
export const metadata: Metadata = {
  ...
  description:
    "Custom-coded websites, local SEO, and Google Ads for Houston businesses. From Rank Point Media — a two-person agency based in San Antonio expanding into the Gulf Coast region.",
