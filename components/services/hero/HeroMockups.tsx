    ...
    <>
      ...
      <CardWrap delay={0.6} rotate={6} className="bottom-2 right-4 w-64 p-4">
        <div className="flex items-start gap-3">
          <div className="shrink-0 w-9 h-9 rounded-full bg-accent-dark/20 flex items-center justify-center">
          ...
          {[
            ...
            <div key={biz.name} className="flex items-center justify-between">
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-[11px] font-mono text-accent-dark w-3">
                  {i + 1}
                </span>
  ...
  return (
    <>
      ...
      <CardWrap delay={0.2} rotate={4} className="top-0 right-0 w-96 p-5">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[10px] font-bold uppercase tracking-widest text-accent-dark bg-accent-dark/10 border border-accent-dark/30 rounded px-1.5 py-0.5">
            Ad
          </span>
          <MonoLabel>Google Ads</MonoLabel>
        </div>
        <p className="text-[11px] text-accent-dark/80 font-mono mb-1">
      ...
      <CardWrap delay={0.4} rotate={-8} className="bottom-16 -left-4 w-56 p-5">
        <div className="flex items-center gap-2 mb-2">
          <MousePointerClick className="w-3.5 h-3.5 text-accent-dark" />
  ...
  return (
    <>
      ...
      <CardWrap delay={0.2} rotate={3} className="top-0 right-0 w-96 p-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-accent-dark" />
            <div className="flex flex-col">
          ...
          <div className="flex gap-0.5">
            {[0, 1, 2, 3, 4].map((i) => (
              <Star key={i} className="w-3 h-3 fill-accent-dark text-accent-dark" />
            ))}
          </div>
        </div>
        <p className="text-white text-xs leading-relaxed">
      ...
      <CardWrap delay={0.6} rotate={6} className="bottom-0 right-2 w-52 p-5">
        <div className="flex items-center gap-2 mb-2">
          <Star className="w-3.5 h-3.5 text-accent-dark" />
  ...
  return (
    <>
      <CardWrap delay={0.2} rotate={-8} className="bottom-20 -left-6 w-64 h-44">
        <div className="w-full h-full rounded-2xl bg-accent-dark/10" />
      </CardWrap>
