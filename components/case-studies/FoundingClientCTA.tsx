    ...
    <section className="px-6 py-16 mb-16">
      <div className="max-w-5xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 md:p-16">
          ...
          <div
            className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-teal-500/20 blur-3xl"
            aria-hidden="true"
          />
          <div
            className="absolute -bottom-20 -left-20 w-80 h-80 rounded-full bg-violet-500/20 blur-3xl"
            aria-hidden="true"
          />
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-300 mb-10 leading-relaxed">
              ...
              case study on this page when we launch their site. It&apos;s
              meant for San Antonio small businesses ready to commit to growth
              and willing to collaborate closely on what we build together.
            </p>

            {/* Trust signals */}
            <div className="inline-flex items-center gap-x-4 gap-y-2 text-sm text-slate-400 mb-10 flex-wrap justify-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-400 text-slate-900 px-6 py-3 rounded-lg font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-teal-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
              >
              ...
              <Link
                href="/services"
                className="inline-flex items-center gap-2 border border-slate-600 hover:border-slate-400 text-white px-6 py-3 rounded-lg font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-teal-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
              >
                See Our Services
              </Link>
            </div>
