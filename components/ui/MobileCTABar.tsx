...
export default function MobileCTABar() {
  ...
  const threeColor = pathname === "/" || pathname === "/about" || pathname === "/services" || pathname.startsWith("/services/") || pathname === "/case-studies" || pathname === "/pricing" || pathname === "/contact" || pathname === "/industries" || pathname.startsWith("/industries/") || pathname === "/privacy" || pathname === "/terms";
  if (threeColor) {
    return (
